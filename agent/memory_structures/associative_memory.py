...
This would include, for example, remembering the name of someone or the aroma of a particular perfume

Note (May 1, 2023) -- this class is the Memory Stream module in the generative agents paper. 
"""
import sys
sys.path.append('../../')
