...
Short-term memory acts as a kind of “scratch-pad” for temporary recall of the information which is being processed at any point in time, 
and has been referred to as "the brain's Post-it note". 
It can be thought of as the ability to remember and process information at the same time. 
It holds a small amount of information (typically around 7 items or even less) in mind 
in an active, readily-available state for a short period of time (typically from 10 to 15 seconds, or sometimes up to a minute)
"""
import datetime
import json
import sys
